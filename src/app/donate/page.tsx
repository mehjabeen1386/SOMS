// import { Heart, Gift, Sparkles, ShieldCheck } from 'lucide-react';
// import Link from 'next/link';

// export default function DonatePage() {
//   return (
//     <div className="py-16 lg:py-24 bg-gradient-to-b from-rose-50/40 to-white">
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="text-center max-w-3xl mx-auto mb-16">
//           <span className="text-rose-600 font-bold tracking-wider uppercase text-sm bg-rose-100 px-4 py-1.5 rounded-full">Make an Impact</span>
//           <h1 className="text-4xl lg:text-5xl font-black text-slate-900 mt-4 mb-4">Support Our Children Today</h1>
//           <p className="text-slate-600 text-lg">Your contribution directly provides nutritious food, school supplies, and medical care.</p>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
//           <div className="bg-white p-8 rounded-3xl shadow-xl border border-rose-100 text-center relative overflow-hidden group hover:border-rose-300 transition-all">
...
//             <div className="text-4xl font-black text-rose-600 my-4">$50<span className="text-sm font-normal text-slate-500">/month</span></div>
//             <p className="text-slate-600 text-sm mb-8">Provides healthy meals and daily nutrition for one child.</p>
//             <button className="w-full py-3.5 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-xl shadow-lg transition-all">
//               Donate $50
//             </button>
//           </div>

//           <div className="bg-gradient-to-b from-rose-600 to-pink-600 text-white p-8 rounded-3xl shadow-2xl text-center transform md:-translate-y-4">
//             <div className="absolute top-0 right-0 bg-amber-400 text-slate-900 text-xs font-bold px-3 py-1 rounded-bl-xl">BEST VALUE</div>
//             <div className="w-14 h-14 bg-white/20 text-white rounded-2xl flex items-center justify-center mx-auto mb-6">
//               <Heart className="w-7 h-7 fill-white" />
//             </div>
//             <h3 className="text-xl font-bold mb-2">Education Supporter</h3>
//             <div className="text-4xl font-black my-4">$100<span className="text-sm font-normal text-rose-200">/month</span></div>
//             <p className="text-rose-100 text-sm mb-8">Covers school tuition, uniforms, books, and tutoring.</p>
//             <button className="w-full py-3.5 bg-white text-rose-600 hover:bg-rose-50 font-bold rounded-xl shadow-lg transition-all">
//               Donate $100
//             </button>
//           </div>

//           <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 text-center hover:border-rose-300 transition-all">
...
//             <div className="text-4xl font-black text-amber-600 my-4">$250<span className="text-sm font-normal text-slate-500">/month</span></div>
//             <p className="text-slate-600 text-sm mb-8">Comprehensive care including medical, clothing, and education.</p>
//             <button className="w-full py-3.5 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-xl shadow-lg transition-all">
//               Donate $250
//             </button>
//           </div>
//         </div>
